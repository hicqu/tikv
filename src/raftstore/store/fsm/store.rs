...
pub struct PollContext<T, C: 'static> {
    ...
    pub mvcc_gc_scheduler: Scheduler<MvccGcTask>,
...
pub struct RaftPollerBuilder<T, C> {
    ...
    pub router: RaftRouter,
    mvcc_gc_scheduler: Scheduler<MvccGcTask>,
    pub importer: Arc<SSTImporter>,
    ...
    C: PdClient + 'static,
{
    ...
    fn build(&mut self) -> RaftPoller<T, C> {
        let ctx = PollContext {
            ...
            mvcc_gc_scheduler: self.mvcc_gc_scheduler.clone(),
...
impl RaftBatchSystem {
    ...
    pub fn spawn<T: Transport + 'static, C: PdClient + 'static>(
        ...
        let mut builder = RaftPollerBuilder {
            ...
            mvcc_gc_scheduler: workers.mvcc_gc_worker.scheduler(),
